...
class MusicManager(val audioDevice : AudioDevice, val samplingRate : Int, val playbackBufferSecs : Float) {
    private var thread : Thread?
    private var running : Boolean
    private var runtime : Double
    private val audioOutputRunnable : Runnable
    private var input : FloatInputStreamReader?
    ...
    fun start(inputStream : FloatInputStreamReader){
        if(!running) {
